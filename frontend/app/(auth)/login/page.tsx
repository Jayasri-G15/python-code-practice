...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-navy-900 flex items-center justify-center p-4"
      style={{ backgroundImage: "radial-gradient(ellipse 80% 60% at 50% -10%, rgba(99,102,241,0.15) 0%, transparent 70%)" }}>
      ...
      >
        ...
        <h1 className="text-3xl font-display font-bold text-white mb-2">Finvora AI</h1>
        <p className="text-white/50 text-sm mb-8">
          Autonomous Financial Intelligence Platform
        </p>

        <div className="space-y-4 mb-8 text-left">
          {["Gmail-powered financial sync", "AI invoice & payment extraction", "Real-time analytics & alerts"].map((f) => (
        ...
        <p className="text-white/30 text-xs mt-6">
          By continuing, you grant Finvora AI read access to your Gmail to extract financial data.
        </p>
      </motion.div>
    </div>
  );
